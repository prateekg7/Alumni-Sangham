...
export default function AboutBorderGlow({
  children,
  className = '',
  edgeSensitivity = 30,
  glowColor = '40 80 80',
  ...
  return (
    <div
      ...
      className={`about-border-glow-card ${className}`}
      style={{
    ...
    >
      ...
      <div className="about-border-glow-inner">{children}</div>
    </div>
  );
}
